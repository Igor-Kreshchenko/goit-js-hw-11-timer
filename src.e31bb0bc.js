...
var CountdownTimer = /*#__PURE__*/function () {
  function CountdownTimer(_ref) {
    ...
    this.onTick = onTick;
    this.refs = {
      daysRef: document.querySelector("".concat(this.selector, " [data-value=\"days\"]")),
      hoursRef: document.querySelector("".concat(this.selector, " [data-value=\"hours\"]")),
      minsRef: document.querySelector("".concat(this.selector, " [data-value=\"mins\"]")),
      secsRef: document.querySelector("".concat(this.selector, " [data-value=\"secs\"]"))
    };
    this.start();
  }
  ...
  _createClass(CountdownTimer, [{
    ...
    value: function updateValues() {
      ...
      var _this$getTimeComponen = this.getTimeComponents(deltaTime),
...
function updateTimerFace(_ref2) {
  var days = _ref2.days,
      hours = _ref2.hours,
      mins = _ref2.mins,
      secs = _ref2.secs;
...
require("./js/timer");
},{"./css/styles":"css/styles.css","./js/timer":"js/timer.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14041" + '/');
